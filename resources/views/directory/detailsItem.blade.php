                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <ul class="list-inline link-list">
                            ...
                            <li><a href="{{ route('directory') }}" data-navigo>Directorio</a></li>
                            <li><span class="TitleDetails"></span> </li>
                        </ul>
                    </div>
                                ...
                                <div class="c-share scale15">
                                    ...
                                    <ul class="c-share_options">
                                        <div class="shareon" data-title="InnovaHub">
                                            <a class="facebook"></a>
                                            <a class="email" href="mailto:?subject='InnovaHub'&amp;body={{ Request::url()  }}"></a>
        ...
        <div class="auto-container">
            <div class="inner-box">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <div class="h-full ">
                            <div class="borderB h-full">
                                <div class="enterpriseTitle"><span class="TitleDetails"></span> </div>
                                <div class="scrollContainer">
                                    <div class="scrollInner">
                                        <div class="detailsMainQuote"> <span id="detailDescription"></span> </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row clearfix mt-5">
                    <div class="info-column col-lg-5 col-md-4 col-sm-12 col-xs-12">
                        <div class="inner-box">
                            <ul>
