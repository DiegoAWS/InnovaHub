    ...
    <div class="clearfix">
        <div class="flex detailsSubContainer">
            <div class="w-60 smallFull p-4">
                ...
                <div id="detailsDescription" class="mt-5" style="text-align: justify;">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-8 ">
                <div class="sidebar-widget brouchure-widget mt-5">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-xs-2 iconDetailsContainer">
                            <div class="flex">
                                <div class="handShakeIcon">
            ...
            <div class="sidebar-side pull-right col-md-4 col-sm-6 col-xs-12">
                <aside class="sidebar">
                    ...
                    <div class="flex">
                        <div class="mx-5">
                            <div class="squareIcon " id="shareButtonDetails">
                            @include("material.shareModal")
