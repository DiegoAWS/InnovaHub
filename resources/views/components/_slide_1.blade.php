<li data-description="Slide Description" data-easein="default" data-easeout="default"
    ...
    data-slotamount="default" data-thumb="{{$slide['img1']}}" data-title="Slide Title"
    ...
    <div class="tp-caption"
        ...
        <h2 class="dark-text text-right"><span>{{$slide['text1']}}</span><br>{{$slide['text2']}}</h2>
    </div>
    ...
    <div class="tp-caption"
         ...
         style="z-index: 7; white-space: nowrap;text-transform:left;">
        <div class="text light text-right">{{$slide['text3']}}</div>
    </div>
