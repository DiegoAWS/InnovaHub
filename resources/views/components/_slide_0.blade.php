<li data-description="Slide Description" data-easein="default"
    ...
    data-thumb="{{$slide['img1']}}" data-title="Slide Title"
    ...
    <div class="tp-caption tp-resizeme rs-parallaxlevel-2"
         ...
         data-frames='[{"delay":200,"speed":750,"sfxcolor":"#64cae5","sfx_effect":"blockfromright","frame":"0","from":"z:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"sfxcolor":"#ffffff","sfx_effect":"blocktoright","frame":"999","to":"z:0;","ease":"Power4.easeOut"}]'
    ...
    <div class="tp-caption   tp-resizeme rs-parallaxlevel-2"
        ...
        <div class="rs-looped rs-wave" data-speed="6" data-angle="0" data-radius="2px"
             data-origin="50% 50%"><img src="{{mix('images/main-slider/border.png')}}" alt=""
                                        data-ww="['309px','309px','300px','300px']"
